...
namespace SourceGit.Commands
{
    ...
    {
        public Merge(string repo, string source, string mode, bool edit, string strategyOption)
        {
        ...
        public Merge(string repo, List<string> targets, bool autoCommit, string strategy, string strategyOption)
        {
            WorkingDirectory = repo;
            Context = repo;
