...
namespace SourceGit.Commands
{
    public class Config : Command
    {
        ...
        public async Task<List<string>> GetLocalValuesAsync(string key)
        {
        ...
        public async Task<bool> SetLocalReplaceAllAsync(string key, string value)
        {
            Args = $"config --local --replace-all {key} {value.Quoted()}";
