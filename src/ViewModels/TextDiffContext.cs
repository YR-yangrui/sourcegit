...
namespace SourceGit.ViewModels
{
    ...
    public class TextDiffContext : ObservableObject
    {
        ...
        public bool SupportsChunkActions => _supportsChunkActions;
        ...
        protected bool _supportsChunkActions = true;
    ...
    {
        public CombinedTextDiff(Models.DiffOption option, Models.TextDiff diff, TextDiffContext previous = null, bool supportsChunkActions = true)
        {
            _option = option;
            _data = diff;
            _supportsChunkActions = supportsChunkActions;
        ...
        {
            return new TwoSideTextDiff(_option, _data, this, _supportsChunkActions);
        }
    }
    ...
    public class TwoSideTextDiff : TextDiffContext
    {
        ...
        public TwoSideTextDiff(Models.DiffOption option, Models.TextDiff diff, TextDiffContext previous = null, bool supportsChunkActions = true)
        {
            _option = option;
            _data = diff;
            _supportsChunkActions = supportsChunkActions;
        ...
        public override TextDiffContext SwitchMode()
        {
            return new CombinedTextDiff(_option, _data, this, _supportsChunkActions);
        }
