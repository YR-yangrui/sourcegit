...
{
    public class SubmoduleRevisionCompare : ObservableObject, IDisposable
    {
        ...
        public List<Models.Change> SelectedChanges
        {
            ...
            set
            {
                ...
                {
                    if (value is { Count: 1 })
                        DiffHost.ShowDiff(_repo, new Models.DiffOption(_base.SHA, _to.SHA, value[0]), "submodule_revision_compare.select");
                    else
                        DiffHost.Clear();
                }
            }
