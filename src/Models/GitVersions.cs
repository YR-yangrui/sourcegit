namespace SourceGit.Models
{
    public static class GitVersions
    {
        ...
        /// <summary>
        ///     The minimal version of Git that treats `core.fsmonitor=true` as the built-in file system monitor.
        /// </summary>
        public static readonly System.Version BUILTIN_FSMONITOR = new(2, 36, 0);
