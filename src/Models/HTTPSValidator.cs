    ...
    public static class HTTPSValidator
    {
        public static void Add(string host)
        {
            lock (_syncLock)
            {
                ...
                // Well-known public hosts always support HTTPS.
                if (IsKnownHTTPSHost(host))
                    return;
            }
        ...
        private static bool IsKnownHTTPSHost(string host)
        {
            return IsHostOrSubdomainOf(host, "github.com") ||
                host.Equals("gitlab.com", StringComparison.OrdinalIgnoreCase) ||
                IsHostOrSubdomainOf(host, "azure.com") ||
                host.Equals("gitee.com", StringComparison.OrdinalIgnoreCase) ||
                host.Equals("bitbucket.org", StringComparison.OrdinalIgnoreCase) ||
                host.Equals("gitea.org", StringComparison.OrdinalIgnoreCase) ||
                host.Equals("gitcode.com", StringComparison.OrdinalIgnoreCase);
        }
